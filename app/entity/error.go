...
var ErrCouldNotFindFile = errors.New("Could not find client file")
var ErrInconsistenciesInCompletedFiles = errors.New("Inconsistencies between client and storagenode")
