...
func (_m *MockRepository) AddPolicyToClient(client string, policy string) error {
...
func (_m *MockRepository) RemoveClientFromPolicy(client string, policy string) error {
	ret := _m.Called(client, policy)
...
func (_m *MockRepository) RemovePolicyFromClient(client string, policy string) error {
	ret := _m.Called(client, policy)
...
func (_m *MockRepository) SearchNewClient() (string, error) {
	ret := _m.Called()
